                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: DesignSystem.Spacing.xs) {
                                Text("\(option, specifier: "%.1f") lbs / week")
                                    .font(isSelected ? PixelFont.bold(16) : PixelFont.regular(16))
                                    .foregroundColor(DesignSystem.Colors.textPrimary)
        ...
        OnboardingStepContainer(
            ...
            VStack(spacing: DesignSystem.Spacing.md) {
                ...
                Button {
                    ...
                    Text("None")
                        .font(allergies.isEmpty ? PixelFont.bold(16) : PixelFont.regular(16))
                        .foregroundColor(DesignSystem.Colors.textPrimary)
...
private struct ResultsStep: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: DesignSystem.Spacing.lg) {
                ...
                .pixelCard(borderColor: DesignSystem.Colors.primary, fillColor: DesignSystem.Colors.cardBackground)
                ...
                if !viewModel.aiTip.isEmpty {
                    VStack(alignment: .leading, spacing: DesignSystem.Spacing.sm) {
                        HStack(spacing: DesignSystem.Spacing.sm) {
                            Image(systemName: "sparkles")
                                ...
                                .clipShape(PixelPillShape())
                                .overlay(PixelPillShape().stroke(Color(hex: "#047857"), lineWidth: 2))
                    ...
                    .padding(DesignSystem.Spacing.md)
                    .pixelCard(borderColor: DesignSystem.Colors.primary.opacity(0.3), fillColor: DesignSystem.Colors.primary.opacity(0.08))
    ...
    private func macroCard(title: String, value: String, color: Color) -> some View {
        ...
        .frame(maxWidth: .infinity)
        .padding(.vertical, DesignSystem.Spacing.md)
        .pixelCard(borderColor: color.opacity(0.5), fillColor: DesignSystem.Colors.cardBackground)
    }
}

...
private struct ResultRow: View {
    ...
    var body: some View {
        HStack {
            Text(label)
                .font(highlight ? AppFont.bold(16) : AppFont.regular(16))
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
                ...
                if let b = bmr, let t = tdee {
                    ResultCard {
                        Text("Results").font(AppFont.bold(18)).foregroundColor(tc.textTertiary)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
                ...
                VStack(alignment: .leading, spacing: DesignSystem.Spacing.xs) {
                    Text("Goal").font(AppFont.regular(14)).foregroundColor(tc.textSecondary)
                ...
                VStack(alignment: .leading, spacing: DesignSystem.Spacing.xs) {
                    Text("Activity Level").font(AppFont.regular(14)).foregroundColor(tc.textSecondary)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
                ...
                VStack(alignment: .leading, spacing: DesignSystem.Spacing.xs) {
                    Text("Lift").font(AppFont.regular(14)).foregroundColor(tc.textSecondary)
                        ...
                        ForEach(levels.indices, id: \.self) { i in
                            ...
                            HStack {
                                HStack(spacing: DesignSystem.Spacing.xs) {
                                    ...
                                    Text(levels[i])
                                        .font(isCurrent ? AppFont.bold(16) : AppFont.regular(16))
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: DesignSystem.Spacing.lg) {
                ...
                VStack(alignment: .leading, spacing: DesignSystem.Spacing.xs) {
                    Text("Diet Style").font(AppFont.regular(14)).foregroundColor(tc.textSecondary)
                ...
                if let r = result {
                    ResultCard {
                        Text("Daily Macros").font(AppFont.bold(18)).foregroundColor(tc.textTertiary)
